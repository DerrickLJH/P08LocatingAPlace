...
public class MainActivity extends AppCompatActivity {
    ...
    private LatLng north;
    private LatLng central;
    private LatLng east;
        ...
        mapFragment.getMapAsync(new OnMapReadyCallback() {
            ...
            public void onMapReady(GoogleMap googleMap) {
                ...
                Marker np = map.addMarker(new
                        ...
                        .position(north)
                        .title("HQ - North")
                        .snippet("414 Sembawang Dr, Singapore 750414")
                ...
                Marker cp = map.addMarker(new
                        ...
                        .snippet("176 Orchard Rd, Singapore 238843")
                ...
                Marker ep = map.addMarker(new
                        ...
                        .position(east)
                        .title("East - Branch")
                        .snippet("878 Tampines Ave 8, Singapore 520878")
